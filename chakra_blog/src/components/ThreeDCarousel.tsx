...
const ThreeDCarousel = () => {
  return (
    <div className="w-full h-[85%] place-items-center grid md:grid-flow-col sm:grid-flow-row gap-6">
      <div></div>

      <div className="threeDGallery">
        <Image
          src={seed}
          width={150}
          height={150}
          alt="Picture of the seed"
          className="imageThreeD rounded-full"
        />
